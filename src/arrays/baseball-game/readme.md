...
[https://neetcode.io/problems/baseball-game/question](https://neetcode.io/problems/baseball-game/question)
...
- `"D"` - Add `5 * 2 = 10` to the record, record = [1, 2, 5, 10].
...
- `"D"` - Add `5 * 2 = 10` to the record, record = [5, 10].
